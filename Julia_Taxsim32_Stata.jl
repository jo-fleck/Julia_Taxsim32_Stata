...
# 1. Instructions
# 2. Function Definition: taxsim32_stata.jl
# 3. Example
...
# Generate temporary Stata do file: loads taxsim32 input data, calls taxsim32.ado, saves taxsim32 output data
...
df_taxsim32_output = CSV.read(dir * "taxsim32_output.csv", DataFrame); # import Taxsim32 output
